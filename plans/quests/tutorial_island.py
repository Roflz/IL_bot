...
import actions.tab as tab
import actions.bank as bank
import actions.chat as chat
import actions.inventory as inventory
import actions.npc as npc
import actions.objects as objects
import actions.player as player
import actions.widgets as widgets
...
class TutorialIslandPlan(Plan):
    ...
    description = """Completes Tutorial Island for new accounts. Handles character creation, tutorial progression, and all tutorial island activities. Supports custom credentials file for account creation.

Starting Area: Tutorial Island
Required Items: None (provided during tutorial)"""
    ...
    def loop(self, ui):
        ...
        match(phase):
            case "START_TUTORIAL": # WORKING! RUN WITHOUT BREAKPOINTS
                ...
                from actions import is_tutorial_open, get_tutorial_name_input_bounds
                if is_tutorial_open():
            ...
            case "CHARACTER_CREATION": #WORKING! RUN WITHOUT BREAKPOINTS
                ...
                if design_buttons:
                    ...
                    from actions.character import customize_character_appearance
