...
following the same pattern as romeo_and_juliet.py and falador_cows.py.
...
class GoblinDiplomacy2Plan(Plan):
    ...
    description = """Completes the Goblin Diplomacy quest using modular bank and GE utilities. Automatically acquires quest items (Blue dye, Orange dye, Goblin mail) and progresses through all quest phases.

Starting Area: Any bank (travels to quest locations)
Required Items: Blue dye, Orange dye, Goblin mail (purchased via GE if needed)"""
