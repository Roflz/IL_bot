...
class FaladorCows2Plan(Plan):
    ...
    description = """Combat training by fighting cows in Falador. Uses simplified bank plan utility for character setup with combat equipment and food. Demonstrates integration with bank and attack utilities.

Starting Area: Falador Bank
Required Items: Combat equipment, Food"""
