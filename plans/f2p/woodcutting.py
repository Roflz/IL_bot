...
class Woodcutting2Plan(Plan):
    ...
    description = """Advanced woodcutting plan with automatic axe upgrades via Grand Exchange. Automatically selects the best axe for your level and sells logs to afford better equipment. Integrates bank and GE utilities for complete automation.

Starting Area: Any bank (travels to trees)
Required Items: Axe (upgrades automatically via GE)"""
