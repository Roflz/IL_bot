...
public interface StateExporter2Config extends Config
{
    ...
    {
        // Check for system property first (for multi-instance setup)
        String dir = System.getProperty("rl.export.dir");
    ...
    {
        // Check for system property first (for multi-instance setup)
        String enabled = System.getProperty("rl.export.enabled");
        if (enabled != null) {
