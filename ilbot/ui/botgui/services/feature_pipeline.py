...
try:
    from ilbot.pipeline.shared_pipeline.features import extract_features_from_gamestate, FeatureExtractor
    from ilbot.pipeline.shared_pipeline.feature_map import load_feature_mappings
    from ilbot.pipeline.shared_pipeline.actions import flatten_action_window, convert_raw_actions_to_tensors
    from ilbot.pipeline.shared_pipeline.normalize import normalize_features, normalize_action_data
...
class FeaturePipeline:
    ...
    def _extract_raw_action_data_using_pipeline(self, gamestates: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        from ilbot.pipeline.shared_pipeline.actions import extract_raw_action_data
