...
def _gmail_service(token_file: str = None):
    ...
    token_path = token_file or "D:/repos/bot_runelite_IL/ilbot/ui/simple_recorder/ui-bot/auth/gmail_oauth/token.json"
    creds = None
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            flow = InstalledAppFlow.from_client_secrets_file("D:/repos/bot_runelite_IL/ilbot/ui/simple_recorder/ui-bot/auth/gmail_oauth/credentials.json", SCOPES)
