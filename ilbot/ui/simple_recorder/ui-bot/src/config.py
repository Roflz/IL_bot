...
class Config:
    ...
    GMAIL_CREDENTIALS = os.getenv("GMAIL_CREDENTIALS", "D:/repos/bot_runelite_IL/ilbot/ui/simple_recorder/ui-bot/auth/gmail_oauth/credentials.json")
    GMAIL_TOKEN = os.getenv("GMAIL_TOKEN", "D:/repos/bot_runelite_IL/ilbot/ui/simple_recorder/ui-bot/auth/gmail_oauth/token.json")
